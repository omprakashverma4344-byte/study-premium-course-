...
## Current deployment
This project is designed for Vercel + MongoDB Atlas. Large course videos/PDFs are delivered from Telegram; they are not uploaded through the Vercel function.

For Telegram delivery, configure `TELEGRAM_BOT_TOKEN`, `TELEGRAM_BOT_USERNAME`, `ADMIN_TELEGRAM_CHAT_ID`, and `APP_URL`. See `docs/TELEGRAM.md`.
